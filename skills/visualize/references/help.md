# visuals:visualize — Help

## Synopsis

```
/visuals:visualize [<file-or-content>]
```
...
Not this skill: an `.excalidraw` file is `visuals:excalidraw-diagram`; a vertical
scroll-snap deck built from a Markdown file is `visuals:md-to-scrolldeck`.
...
```
/visuals:visualize /path/to/notes.md
/visuals:visualize "Q2 product roadmap with 4 epics and 12 stories"
/visuals:visualize -h
```
