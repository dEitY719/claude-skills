...
```bash
cd .claude/skills/visuals:excalidraw-diagram/references && uv run python render_excalidraw.py <path-to-file.excalidraw>
```
...
```bash
cd .claude/skills/visuals:excalidraw-diagram
uv sync
